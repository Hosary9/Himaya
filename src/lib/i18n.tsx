...
const translations = {
  ar: {
    ...
    'settings.update_phone': 'تحديث رقم الهاتف',
    ...
    'settings.case_updates': 'تحديثات القضايا',
    'settings.lawyer_messages': 'رسائل المحامين',
    'settings.support': 'الدعم',
    'settings.help_center': 'مركز المساعدة',
    'settings.contact_support': 'تواصل معنا',
    'settings.report_issue': 'الإبلاغ عن مشكلة',
  ...
  en: {
    ...
    'settings.update_phone': 'Update Phone',
    'settings.app_settings': 'App Settings',
    'settings.language': 'Language',
    'settings.dark_mode': 'Dark Mode',
    'settings.notifications': 'Notifications',
    'settings.enable_notifications': 'Enable Notifications',
    'settings.case_updates': 'Case Updates',
    'settings.lawyer_messages': 'Lawyer Messages',
