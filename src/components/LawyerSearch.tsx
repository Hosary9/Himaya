...
const MOCK_LAWYERS = [
  ...
  },
  {
    ...
    isExpatSpecialist: false,
    isCertified: true,
    description: "محامي بالنقض بخبرة 28 سنة في مجال المحاماة، متخصص في قضايا الجنح والمدني والأسرة والتعويضات. قام بالترافع في أكثر من 30 ألف قضية أمام مختلف درجات التقاضي، ويقدم استشارات قانونية دقيقة ومتابعة احترافية للقضايا.\n\nمتخصص في:\n- القضايا المدنية وقضايا الأسرة والأحوال الشخصية\n- قضايا التعويضات المادية والمعنوية\n- قضايا العقود وصياغتها ومراجعتها\n- منازعات الأراضي والعقارات\n- قضايا حوادث السيارات وإصابات العمل",
    badges: ["✔ محامي بالنقض", "✔ خريج شريعة وقانون", "✔ 28 سنة خبرة", "✔ أكثر من 30 ألف قضية", "✔ متخصص في التعويضات", "✔ سوهاج مركز طما"]
  }
];
