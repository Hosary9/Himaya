  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center gap-3 mb-2">
        <div className="w-12 h-12 rounded-xl bg-secondary/10 flex items-center justify-center text-secondary border border-secondary/20 shadow-sm">
          <BookOpen size={28} />
        </div>
        <div>
      ...
      <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
        {CATEGORIES.map(cat => (
          <button
            ...
            className={cn(
              "whitespace-nowrap px-4 py-2.5 rounded-xl text-sm font-bold transition-all border flex items-center gap-2",
              activeCategory === cat.id
                ? "bg-secondary text-surface border-secondary shadow-md"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {filteredCards.map(card => (
          <div key={card.id} className="bg-surface rounded-2xl p-5 border border-border shadow-sm flex flex-col h-full hover:shadow-md transition-all">
            ...
            <button 
              ...
              className="w-full py-3 rounded-xl bg-primary/5 text-primary font-bold text-sm flex items-center justify-center gap-2 hover:bg-primary/10 transition-colors mt-auto border border-primary/10"
            >
